...
//    private JMenuItem menuItem5;
    ...
    public Calculator() {
        ...
        operationImages.add(new ImageIcon("./add.png"));
        operationImages.add(new ImageIcon("./subtract.png"));
        operationImages.add(new ImageIcon("./multiply.png"));
        operationImages.add(new ImageIcon("./divide.png"));
        operationImages.add(new ImageIcon("./equal.png"));
        //resizing images
